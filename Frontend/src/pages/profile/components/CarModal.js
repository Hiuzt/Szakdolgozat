...
const { createCar } = require("../../../services/carServices/carService");
...
const CarModal = (props) => {
    ...
    const distanceTravelRef = useRef();
    ...
    function onCreateCar() {
        ...
        formData.append("DistanceTravelled", distanceTravelRef.current.value);
        formData.append("SeatNumber", seatNumberRef.current.value)
        ...
        <div className="modal-container-admin" onClick={(e) => {
            ...
            <div className="modal-content-admin">
                ...
                <div className="input-container">                      
                    <input type = "number" id = "Férőhely" ref={seatNumberRef} required />
                    <label for="Férőhely" >Férőhely</label>
                </div>
                <div className="input-container">                      
                    <input type = "number" id = "Megtett távolság" ref={distanceTravelRef} required />
                    <label for="Megtett távolság" >Megtett távolság</label>
                </div>                    
            </div>
        <div className="control-button-container">
           
            <div className="control-button" onClick={(e) => onCreateCar()}>
                Új autó létrehozása
            </div>
